      ...
      if (isIOS && isSafari) {
        return {
          ...
          steps: [
            ...
            `سایت ${BASE_DOMAIN} را پیدا کرده و Allow را انتخاب کنید`
          ]
        };
                ...
                onClick={() => {
                  ...
                  if (isChrome || isEdge) {
                    try {
                      ...
                      alert(`لطفاً به Chrome Settings > Privacy and security > Site settings > Notifications بروید و ${BASE_DOMAIN} را Allow کنید`);
                    }
                  } else if (isFirefox) {
                    try {
                    ...
                    alert(`لطفاً به Safari > Settings > Websites > Notifications بروید و ${BASE_DOMAIN} را Allow کنید`);
                  } else if (isIOS) {
                    alert(`لطفاً به Settings > Safari > Notifications بروید و ${BASE_DOMAIN} را Allow کنید`);
                  } else {
