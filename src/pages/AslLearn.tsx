      ...
      <Card className="bg-gradient-to-r from-blue-900/20 to-blue-800/20 border-blue-700/50 rounded-3xl">
        <CardContent className="p-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-2xl font-bold text-white">آموزش اصل مارکت</h2>
              <p className="text-blue-300">انتخاب محصول و آموزش فروش حرفه‌ای</p>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredProducts.map((product) => (
            <Card key={product.id} className="bg-gray-900/50 border-gray-800 hover:border-gray-700 transition-all group rounded-3xl">
              <CardContent className="p-0">
                <div className="relative">
                  ...
                  <div className="absolute top-4 right-4">
                    <Badge className="bg-orange-500/20 text-orange-300 border-orange-500/30 rounded-full">
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-3 mb-4">
                    <div className="flex items-center justify-between">
                      <span className="text-gray-400 text-sm">سطح دشواری:</span>
                      <Badge className={`${getDifficultyColor(product.difficulty)} rounded-2xl`}>
                        {product.difficulty}
                      </Badge>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-gray-400 text-sm">سود تخمینی:</span>
                  ...
                  <div className="mb-4">
                    <span className="text-gray-400 text-sm block mb-2">بازارهای هدف:</span>
      ...
      <div>
        ...
        <div className="grid md:grid-cols-2 gap-4">
          {trainingModules.map((module) => (
            <Card key={module.id} className="bg-gray-900/50 border-gray-800 hover:border-gray-700 transition-all rounded-3xl">
              <CardContent className="p-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <Card className="bg-gray-900/50 border-gray-800 rounded-3xl">
          <CardContent className="p-4 text-center">
            ...
            <p className="text-sm text-gray-400">محصول آموزشی</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-gray-900/50 border-gray-800 rounded-3xl">
          <CardContent className="p-4 text-center">
            ...
            <p className="text-sm text-gray-400">دانشجوی فعال</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-gray-900/50 border-gray-800 rounded-3xl">
          <CardContent className="p-4 text-center">
            ...
            <div className="text-2xl font-bold text-white">۸۷%</div>
        ...
        <Card className="bg-gray-900/50 border-gray-800 rounded-3xl">
          <CardContent className="p-4 text-center">
            ...
            <p className="text-sm text-gray-400">امتیاز دوره‌ها</p>
          </CardContent>
        </Card>
      </div>
    </div>
