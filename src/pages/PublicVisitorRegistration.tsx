      ...
      case 2:
        ...
        for (const dest of finalDestinations) {
          ...
          const isIranian = iranianTerms.some(term => {
            ...
            return destLower.includes(termLower);
          });
          ...
          // Check if contains Arabic country - check all possible matches
          const containsArabic = arabicCountries.some(country => {
            const countryLower = country.toLowerCase();
            return destLower.includes(countryLower);
          });
          
          console.log(`🔍 Contains Arabic country: ${containsArabic}`);
          ...
          if (!containsArabic) {
            ...
            console.log('❌ Available Arabic countries (first 15):', arabicCountries.slice(0, 15));
            return false;
          }
