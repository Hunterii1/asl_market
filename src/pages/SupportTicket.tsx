              ...
              <div className="flex items-center gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-blue-700 dark:text-blue-300 text-lg">
                    تیم پشتیبانی اصل مارکت همواره در خدمت شماست
                  </p>
                  ...
                  <div className="mt-4 p-4 bg-white dark:bg-gray-800 rounded-2xl border-2 border-blue-200 dark:border-blue-800">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-muted-foreground">ساعت پاسخگویی: 9 تا 17</p>
                        <a 
                          href="tel:09966357737" 
                          className="text-lg font-bold text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-colors mt-1 inline-block"
                        >
                          09966357737
                        </a>
                      </div>
        ...
        <Card className="border-2 border-dashed border-blue-200 dark:border-blue-800 bg-blue-50/30 dark:bg-blue-900/10">
          <CardContent className="p-12 text-center">
            ...
            <p className="text-blue-700 dark:text-blue-300 mb-6 max-w-md mx-auto leading-relaxed">
              اولین تیکت پشتیبانی خود را ایجاد کنید و از خدمات پشتیبانی اصل مارکت بهره‌مند شوید
            </p>
