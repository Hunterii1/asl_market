...
import { clearAffiliateSession, getAffiliateUser } from "@/services/affiliateApi";

const navItems = [
  { title: "داشبورد", icon: LayoutDashboard, href: "/affiliate/dashboard" },
  { title: "کاربران", icon: Users, href: "/affiliate/users" },
  { title: "پرداخت‌ها", icon: CreditCard, href: "/affiliate/payments" },
  { title: "درخواست برداشت", icon: Wallet, href: "/affiliate/withdrawals" },
];
