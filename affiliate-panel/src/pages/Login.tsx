...
import { affiliateApi, setAffiliateSession, clearAffiliateSession } from "@/lib/affiliateApi";
...
export default function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error(err instanceof Error ? err.message : "نام کاربری یا رمز عبور اشتباه است");
    } finally {
      setLoading(false);
    }
  };
