...
export function AdminSidebar({ mobileOpen = false, onMobileClose }: AdminSidebarProps) {
  ...
  const allNavItems: NavItem[] = [
    ...
    { title: 'درخواست‌های مچینگ', icon: TrendingUp, href: '/matching/requests', permissionKey: 'matching' },
    { title: 'پروژه‌های ویزیتوری', icon: Briefcase, href: '/matching/projects', permissionKey: 'matching' },
    { title: 'چت‌های مچینگ', icon: MessagesSquare, href: '/matching/chats', permissionKey: 'matching' },
