...
interface SuppliersFiltersProps {
  ...
  categoryFilter: ('electronics' | 'clothing' | 'food' | 'books' | 'furniture' | 'automotive' | 'other')[];
  onCategoryFilterChange: (category: ('electronics' | 'clothing' | 'food' | 'books' | 'furniture' | 'automotive' | 'other')[]) => void;
  onReset: () => void;
}
...
export function SuppliersFilters({
  ...
  const handleToggleCategory = (category: 'electronics' | 'clothing' | 'food' | 'books' | 'furniture' | 'automotive' | 'other') => {
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  {categoryFilter.map(category => (
                    <Badge key={category} variant="secondary" className="gap-1">
                      ...
                      {category === 'food' && 'غذا'}
                      {category === 'books' && 'کتاب'}
                      {category === 'furniture' && 'مبلمان'}
                      {category === 'automotive' && 'خودرو'}
                      {category === 'other' && 'سایر'}
                      <button
