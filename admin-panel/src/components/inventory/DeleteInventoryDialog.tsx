...
interface DeleteInventoryDialogProps {
  ...
  inventory: { id: string; productName: string } | null;
  onConfirm: () => void;
  isDeleting?: boolean;
}
      ...
      <AlertDialogContent className="rounded-2xl">
        <AlertDialogHeader className="text-right">
          ...
          <AlertDialogDescription className="text-right">
            آیا از حذف موجودی انبار برای محصول <span className="font-semibold text-foreground">{inventory.productName}</span> اطمینان دارید؟
            <br />
